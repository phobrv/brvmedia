...
class BrvmediaServiceProvider extends ServiceProvider {
	/**
	...
	public function register(): void{
		$this->mergeConfigFrom(__DIR__ . '/../config/brvmedia.php', 'brvmedia');

		// Register the service the package provides.
		$this->app->singleton('brvmedia', function ($app) {
			return new Brvmedia;
		});
	}
	...
	protected function bootForConsole(): void{
		...
		$this->publishes([
			__DIR__ . '/../config/brvmedia.php' => config_path('brvmedia.php'),
		], 'brvmedia.config');
...
*/
		...
		$this->commands([
			Console\Commands\ProcessVideoUpload::class,
		]);
	}
}
